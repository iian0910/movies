...
export default {
    ...
    methods: {
        ...
        openDetail (detail) {
            var myModal = document.getElementById('moviesModal')
            ...
            myModal.addEventListener('shown.bs.modal', function () {
                ...
                document.getElementById('movies_poster').setAttribute('src', 'https://image.tmdb.org/t/p/w500' + detail.poster_path)
